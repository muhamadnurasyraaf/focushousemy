  ...
  return (
    <div className="space-y-0">
      {blocks.map((block) => {
        switch (block.type) {
          case "hero": {
            const d = block.data as import("@/lib/blocks").HeroBlockData;
            return (
              <div
                key={block.id}
          ...
          case "image-text": {
            const d = block.data as import("@/lib/blocks").ImageTextBlockData;
            const bg =
          ...
          case "carousel": {
            const d = block.data as import("@/lib/blocks").CarouselBlockData;
            return (
          ...
          case "gallery": {
            const d = block.data as import("@/lib/blocks").GalleryBlockData;
            const colClass =
              d.columns === 2
                ? "md:grid-cols-2"
                : d.columns === 4
          ...
          case "full-width-banner": {
            const d =
              block.data as import("@/lib/blocks").FullWidthBannerBlockData;
            return (
              <div
                key={block.id}
...
export default function PhotographyPageEditor() {
